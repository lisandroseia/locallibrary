...
exports.bookinstance_list = asyncHandler(async (req, res, next) => {
  const allBookInstances = await BookInstance.find().exec()
  ...
  body("due_back", "Invalid date")
    ...
    asyncHandler(async (req,res,next) => {
      ...
      if(!errors.isEmpty()){
        ...
        res.render("bookinstance_form", {title: "Create bookInstance",title: "Create BookInstance",
        book_list: allBooks,
...
exports.bookinstance_delete_get = asyncHandler(async (req, res, next) => {
  ...
  const bookInstance = await BookInstance.findById(req.params.id, "id book status").populate("book").exec()
  if(bookInstance ===null){
...
exports.bookinstance_update_get = asyncHandler(async (req, res, next) => {
  ...
  res.render("bookinstance_form", {title: "Update copy",
  bookinstance: bookInstance,
  book_list: allBooks,
  selected_book: bookInstance.book._id,
})
